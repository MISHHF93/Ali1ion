...
touch application-integration/backend-services/python-app/ali1ion_functions.py
...
mv application-integration/backend-services/python-app/ali1ion_functions.py application-integration/backend-services/python-app/ali1ion_functions.py
