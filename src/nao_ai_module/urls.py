...
urlpatterns = [
    ...
    path('generate_image/', views.generate_image, name='generate_image'),  # Generate image route
    path('generate_text/', views.generate_text, name='generate_text'),  # Generate text route
