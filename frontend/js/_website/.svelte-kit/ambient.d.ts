...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies__gradio_code: string;
	...
	export const npm_package_dependencies__gradio_paramviewer: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies__gradio_code: string;
		...
		npm_package_dependencies__gradio_paramviewer: string;
		DB_USER: string;
		MAVEN_ROOT: string;
		RUBY_HOME: string;
		rvm_path: string;
