...
type RouteId = '/[[version]]/docs/js/storybook';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../../src/routes/[[version]]/docs/js/storybook/+page.server.js').load>>>>>>;
