...
type RouteId = '/[[version]]/docs/js-client';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/[[version]]/docs/js-client/+page.server.js').load>>>>>>;
