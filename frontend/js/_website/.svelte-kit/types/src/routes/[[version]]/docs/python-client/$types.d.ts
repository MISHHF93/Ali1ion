...
type RouteId = '/[[version]]/docs/python-client';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/[[version]]/docs/python-client/+page.server.js').load>>>>>>;
