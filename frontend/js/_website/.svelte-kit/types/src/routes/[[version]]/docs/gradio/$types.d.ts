...
type RouteId = '/[[version]]/docs/gradio';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/[[version]]/docs/gradio/+page.server.js').load>>>>>>;
