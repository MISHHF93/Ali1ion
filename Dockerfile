...
COPY application_integration/backend_services/python_app/ ./application_integration/backend_services/python_app/
...
COPY application_integration/backend_services/node_app/package*.json ./application_integration/backend_services/node_app/
RUN npm install --only=production

# Copy application code for Node.js app
COPY application_integration/backend_services/node_app/ ./application_integration/backend_services/node_app/
...
COPY application_integration/ ./application_integration/
